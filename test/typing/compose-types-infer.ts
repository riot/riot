...
export const wrapper: WithTypes<
  DefaultProps,
  {
...
export const emitEvents: WithTypes<
  DefaultProps,
  {
...
export const Component = composeTypes(
  wrapper,
  emitEvents,
)({
...
export const Component2 = composeTypes(
  wrapper,
  emitEvents,
)({
  //@ts-expect-error
...
export const Component4 = composeTypes(
