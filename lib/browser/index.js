...
import { isFunction, setAttr, $$, each } from './util'
import { __tagImpl, __virtualDom, T_STRING } from './global-variables'
...
riot.util = { brackets: tmpl.brackets, tmpl: tmpl.tmpl }
...
riot.tag = function(name, html, css, attrs, fn) {
  ...
  if (css) {
    ...
    riot.styleNode = styleManager.styleNode
  }
