function Tag(impl, conf, innerHTML) {
  ...
  this.mount = function() {
    ...
    console.log('this.mount of ', root)
    ...
    if (isLoop) {
      ...
      while (dom.firstChild) {
        console.log('Inside this.mount. appending ', dom.firstChild, ' to ', root)
        root.appendChild(dom.firstChild)
      }
      if (root.stub) {
        console.log('There is root.stub: ', root.stub, ' Setting root as ', root)
