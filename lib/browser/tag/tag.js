function Tag(impl, conf, innerHTML) {
  ...
  this.mount = function() {
    ...
    if (!self.parent) {
      each(triggerQueue.mount, function(tag) { tag.trigger('mount') })
      self.trigger('mount')
      triggerQueue.mount = undefined
    } else {
      if (typeof triggerQueue.mount === 'undefined') triggerQueue.mount = []
      triggerQueue.mount.push(self)
    }
