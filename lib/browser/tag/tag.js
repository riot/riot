...
export default function Tag(impl = {}, conf = {}, innerHTML) {
  ...
  // create a clone of the tag instance for use within the update cycle
  proxyTag = {
    '__': this.__,
  ...
  defineProperty(this, 'update', function tagUpdate(data) {
    ...
    // extend tmpTag with the live tag
    // this will be extended and used as the basis for calls to shouldUpdate
    // fixes #2285
    extend(proxyTag, this)

    // make sure the data passed will not override
    // the component core methods
    data = cleanUpData(data)
    extend(proxyTag, data)
    updateOpts.apply(proxyTag, [isLoop, parent, isAnonymous, nextOpts, instAttrs])
