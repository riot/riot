function Tag(impl, conf, innerHTML) {
  ...
  this.mount = function() {
    ...
    if (!self.parent) {
      each(riot.tagsToTriggerMount, function(tag) { tag.trigger('mount') })
      self.trigger('mount')
      riot.tagsToTriggerMount = []
    } else {
      if (typeof riot.tagsToTriggerMount === 'undefined') riot.tagsToTriggerMount = []
      riot.tagsToTriggerMount.push(self)
    }
