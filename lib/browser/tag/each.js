...
import { remAttr, getAttr, getOuterHTML, createDOMPlaceholder, createFrag } from './../common/util/dom'
 ...
 */
function move(patch) {
  var { i, tags, isVirtual, tag, root, item } = patch
...
function insert(patch) {
  var { i, tags, isVirtual, tag, frag, root, mustAppend } = patch,
    dom
  ...
  if (isVirtual)
    ...
    if (mustAppend)
      ...
      root.insertBefore(dom, tags[i].root)
}
  ...
  expr.update = function updateEach() {
    ...
    each(items, function(item, i) {
      ...
      if (
        ...
        insert({ mustAppend, root, i, tags, isVirtual, tag, frag })
      ...
      if (pos !== i && _mustReorder) {
        move({ item, i, tags, isVirtual, tag, dom, frag, root })
