...
import { T_STRING, T_OBJECT, __TAG_IMPL, SPECIAL_TAGS_REGEX, FIREFOX } from '../global-variables'
import { remAttr, getAttr, getTagName, getTag, isArray, arrayishAdd, arrayishRemove, defineProperty, getOuterHTML, moveChildTag, each, makeVirtual, moveVirtual } from '../util'
