...
import { defineProperty, each, debounce } from './../common/util/misc'
 ...
 * @param   {[type]}  nextTag   [description]
 * @param   {Boolean} isVirtual [description]
 * @returns {[type]}            [description]
 */
function insert(root, nextTag, isVirtual) {
  if (isVirtual)
    makeVirtual(this, root, nextTag)
  else
    root.insertBefore(this.root, nextTag.root)
}
