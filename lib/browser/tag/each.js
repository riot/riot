...
function _each(dom, parent, expr) {
  ...
  parent.one('premount', function () {
    ...
    each(items, function(item, i) {
      ...
      // transform the item to a different object
      // according to the expression used in the each property
      ...
      if (!tag) {
        ...
        tag.mount()
        // this tag will be appended at the end of our list
    ...
    // but we want to track the `myTag.tags['child']` property looping a custom child node named `child`
