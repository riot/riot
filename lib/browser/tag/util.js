...
// if third option set as TRUE, the member methods will be bind to obj (cf. Mixin)
function extend(obj, from, from2) {
  var bindIt = from2 === true
  from && each(Object.keys(from), function(key) {
    obj[key] = bindIt && 'function' == typeof from[key]
             ? from[key].bind(obj)
             : from[key]
  })
  return !bindIt && from2 ? extend(obj, from2) : obj
}
