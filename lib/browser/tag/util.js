...
/**
 * Check whether an object property could be overridden
 * @param   { Object }  obj - object to test
 * @param   { String }  prop - property to test
 * @returns {Boolean} is obj[prop] writable?
 */
function isWritable(obj, prop) {
  return !obj[prop] || Object.getOwnPropertyDescriptor(obj, prop).writable
}
...
var injectStyle = (function() {
  ...
  // inject the new node into the DOM
  if (styleNode.styleSheet) {
    document.body.appendChild(styleNode)
  } else {
    if (placeholder) {
      placeholder.parentNode.insertBefore(styleNode, placeholder)
