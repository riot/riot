...
import { RIOT_TAG, RE_BOOL_ATTRS } from './../common/global-variables'
import { walk, getAttr, each, getTag, initChildTag, remAttr } from './../common/util'
...
export function parseAttributes(dom, attrs, tag, fn) {
  each(attrs, function(attr) {
    var name = attr.name, bool = RE_BOOL_ATTRS.test(name), expr
