 ...
 */
export function addChildTag(tag, tagName, parent) {
 ...
 * @returns { Object } DOM node just created
 */
export function mkElWithInnerHTML(name, innerHTML) {
  var el = mkEl(name)
 ...
 */
export function replaceYield(tmpl, innerHTML) {
 ...
 */
export function getNamedKey(dom) {
 ...
 */
export function setNamed(dom, parent, keys) {
