...
riot.tag = function(name, html, fn) {
  ...
  var tag_obj = (typeof name == 'object') ? name : { name: name, tmpl: html, fn: fn }
  tag_impl[tag_obj.name] = tag_obj
}
...
var mountTo = riot.mountTo = function(root, tagName, opts) {
  ...
  if (impl && root) {
    ...
    tag = new Tag(impl, { root: root, opts: opts }, riot.settings, tag_impl, expr_begin)
  }
