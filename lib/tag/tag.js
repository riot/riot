...
function Tag(impl, conf, settings, tag_impl, expr_begin) {
  ...
  this.update = function(data, init) {
    ...
    self.trigger('update')
    updateOpts()
    update(expressions, self, item, doc)
  ...
  // layout
  parseLayout(dom, this, expressions, settings, tag_impl, expr_begin)
