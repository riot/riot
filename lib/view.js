...
;(function(riot, doc) {
  ...
  function mkdom(template) {
    ...
    if ((type = TABLE_CONTENT_REGEXP.exec(template))) {
      ...
      var leaf = /(td|th)/.test(type) && el.getElementsByTagName('tr')
  ...
  function createTag(conf) {
    ...
    var opts = conf.opts || {};
    var dom = mkdom(conf.tmpl);
    var mountNode = conf.root;
    var parent = conf.parent;
    var ast = parse(dom);
    var tag = { root: mountNode, opts: opts, parent: parent, __item: conf.item };
    var attributes = {}
