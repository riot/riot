...
;(function(riot, doc) {
  ...
  /**
  * when you mount your element that return instances of mounted nodes
  * you can unmount this same mounted nodes
  * @example
  *   var mounteds = riot.mount('page-node');
  *   ...do 
  *   riot.unmount(mounteds);
  */
  riot.unmount = function(nodes){
    each(nodes, function(node) {
      while (node.root.hasChildNodes()) {
        node.root.removeChild(node.root.lastChild)
      }
      node.root.riot = 0;
